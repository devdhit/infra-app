...
export default function PCAssetsPage() {
  ...
  useEffect(() => {
    ...
    const checkPermissions = async () => {
      ...
      try {
        ...
        logger.debug('=== PC ASSETS PERMISSION CHECKING STARTED ===');
        ...
        logger.debug('=== PC ASSETS PERMISSION CHECKING FINISHED ===');
      }
    };
  ...
  return (
    <Suspense fallback={<AssetListSkeleton />}>
      <AssetList
        key="pc" // Add key prop to ensure proper re-rendering when switching asset types
        assetType="pc"
