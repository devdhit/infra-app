...
export default function LicenseAssetsPage() {
  ...
  useEffect(() => {
    ...
    const checkPermissions = async () => {
      ...
      try {
        ...
        logger.debug('=== LICENSE ASSETS PERMISSION CHECKING STARTED ===');
        ...
        logger.debug('=== LICENSE ASSETS PERMISSION CHECKING FINISHED ===');
      }
    };
  ...
  }, [canViewLicense, canCreateLicense, canEditLicense, canDeleteLicense, canBulkDeleteLicense, currentUser, isUserLoading]);
  ...
  return (
    <Suspense fallback={<AssetListSkeleton />}>
      <AssetList
        key="license" // Add key prop to ensure proper re-rendering when switching asset types
        assetType="license"
