...
export default function PrinterAssetsPage() {
  ...
  useEffect(() => {
    ...
    const checkPermissions = async () => {
      ...
      try {
        ...
        logger.debug('=== PRINTER ASSETS PERMISSION CHECKING STARTED ===');
        ...
        logger.debug('=== PRINTER ASSETS PERMISSION CHECKING FINISHED ===');
      }
    };
  ...
  }, [canViewPrinter, canCreatePrinter, canEditPrinter, canDeletePrinter, canBulkDeletePrinter, currentUser, isUserLoading]);
  ...
  return (
    <Suspense fallback={<AssetListSkeleton />}>
      <AssetList
        key="printer" // Add key prop to ensure proper re-rendering when switching asset types
        assetType="printer"
