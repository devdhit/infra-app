...
-- AddForeignKey
ALTER TABLE "public"."History" ADD CONSTRAINT "history_fixedasset_fkey" FOREIGN KEY ("recordId") REFERENCES "public"."FixedAsset"("id") ON DELETE RESTRICT ON UPDATE CASCADE;